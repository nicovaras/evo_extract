...
const PARTS: PartDefinition[] = [
  // Arms
  { id: 'garras_rapidas',      name: 'Garras Rápidas',       slot: 'Arms',  tier: 'T1', cost: 55,  statModifiers: { attackRate: 0.5,  damage: -3 } },
  { id: 'martillos_oseos',     name: 'Martillos Óseos',      slot: 'Arms',  tier: 'T2', cost: 120, statModifiers: { damage: 6, attackRate: -0.4, speed: -0.5 } },
  { id: 'latigos_tendinosos',  name: 'Látigos Tendinosos',   slot: 'Arms',  tier: 'T3', cost: 210, statModifiers: { damage: 4, attackRate: 0.3, armor: -1 } },
  // Legs
  { id: 'patas_felinas',       name: 'Patas Felinas',        slot: 'Legs',  tier: 'T1', cost: 55,  statModifiers: { speed: 1.5, maxHp: -15 } },
  { id: 'piernas_saltador',    name: 'Piernas Saltador',     slot: 'Legs',  tier: 'T2', cost: 120, statModifiers: { armor: -1 } },
  { id: 'zancos_queratinosos', name: 'Zancos Queratinosos',  slot: 'Legs',  tier: 'T3', cost: 210, statModifiers: { speed: -0.5 } },
  // Head
  { id: 'craneo_cazador',      name: 'Cráneo Cazador',       slot: 'Head',  tier: 'T1', cost: 55,  statModifiers: { critChance: 0.08, critMult: 0.3, attackRate: -0.3 } },
  { id: 'ojo_compuesto',       name: 'Ojo Compuesto',        slot: 'Head',  tier: 'T2', cost: 120, statModifiers: { pickupRadius: 1.0, damage: -2 } },
  { id: 'bulbo_neural',        name: 'Bulbo Neural',         slot: 'Head',  tier: 'T3', cost: 210, statModifiers: { critChance: 0.05, maxHp: -20 } },
  // Torso
